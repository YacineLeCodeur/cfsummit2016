...
public class CouchDBConnectionHandler {
	public static void createUser(String userName, String password, CouchDbInstance dbInstance) {
		CouchDbConnector userDatabase = new StdCouchDbConnector("_users", dbInstance);
	...
	public static CouchDbInstance connectToCouchDBInstance(String adminUserName, String adminPassword,
			ServerAddress host) {
